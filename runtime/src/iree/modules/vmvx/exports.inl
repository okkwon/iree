...
EXPORT_FN("query_tile_sizes.1d", iree_vmvx_query_tile_sizes_1d, query_tile_sizes_1d, Ii, I)
EXPORT_FN("query_tile_sizes.2d", iree_vmvx_query_tile_sizes_2d, query_tile_sizes_2d, IIi, II)
EXPORT_FN("reduce_max.2d.f32", iree_uk_x32u_reduce_maxf_2d, ukernel_x32u_2d, rIIIrIIIII, v)
EXPORT_FN("reduce_sum.2d.f32", iree_uk_x32u_reduce_sumf_2d, ukernel_x32u_2d, rIIIrIIIII, v)
...
EXPORT_FN("topk.2d.f32", iree_uk_topkf_2d, topk_2d_x32, rIIIrIIIrIIIIII, v)
