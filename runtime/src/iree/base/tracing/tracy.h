...
// The minimal versions are the same as the normal ones.
#define IREE_TRACE_ZONE_BEGIN_MINIMAL IREE_TRACE_ZONE_BEGIN
#define IREE_TRACE_ZONE_BEGIN_NAMED_MINIMAL IREE_TRACE_ZONE_BEGIN_NAMED
#define IREE_TRACE_ZONE_BEGIN_NAMED_DYNAMIC_MINIMAL \
  IREE_TRACE_ZONE_BEGIN_NAMED_DYNAMIC
#define IREE_TRACE_ZONE_BEGIN_EXTERNAL_MINIMAL IREE_TRACE_ZONE_BEGIN_EXTERNAL
#define IREE_TRACE_ZONE_END_MINIMAL IREE_TRACE_ZONE_END
#define IREE_RETURN_AND_END_ZONE_IF_ERROR_MINIMAL \
  IREE_RETURN_AND_END_ZONE_IF_ERROR
#define IREE_TRACE_ZONE_SET_COLOR_MINIMAL IREE_TRACE_ZONE_SET_COLOR
#define IREE_TRACE_ZONE_APPEND_VALUE_I64_MINIMAL \
  IREE_TRACE_ZONE_APPEND_VALUE_I64
#define IREE_TRACE_ZONE_APPEND_TEXT_MINIMAL IREE_TRACE_ZONE_APPEND_TEXT
#define IREE_TRACE_ZONE_APPEND_TEXT_CSTRING_MINIMAL \
  IREE_TRACE_ZONE_APPEND_TEXT_CSTRING
#define IREE_TRACE_ZONE_APPEND_TEXT_STRING_VIEW_MINIMAL \
  IREE_TRACE_ZONE_APPEND_TEXT_STRING_VIEW
